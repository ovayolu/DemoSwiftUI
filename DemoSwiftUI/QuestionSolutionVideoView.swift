//
//  QuestionSolutionVideoView.swift
//  DemoSwiftUI
//
...
struct QuestionSolutionVideoView: View {
    let question: Question
    
    var body: some View {
        PlayerContainerView(url: URL(string: question.videoURL)!)
    }
}

struct QuestionSolutionVideoView_Previews: PreviewProvider {
    static var previews: some View {
        QuestionSolutionVideoView(question: Question(name: "1. Soru", imageURL: "0001", videoURL: "https://mnmedias.api.telequebec.tv/m3u8/29880.m3u8", testPaper: "Test 1", isCompleted: true))
    }
}
